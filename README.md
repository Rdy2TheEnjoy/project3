...
В проекте реализован декоратор `log`, который автоматически логирует выполнение функций.

### Возможности

- Логирует **успешное выполнение** функции.
- Логирует **ошибки** с указанием типа ошибки и переданных аргументов.
- Поддерживает **запись в файл** (если передан параметр `filename`).
